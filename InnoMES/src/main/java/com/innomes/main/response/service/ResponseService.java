package com.innomes.main.response.service;
...
//    // 파일 결과만 처리하는 메소드
//    public FileResult getFileResult(Resource resource) {
//        FileResult result = new FileResult();
//        setFileSuccessResult(result, resource);
//        return result;
//    }
...
//    private void setFileSuccessResult(FileResult result, Resource resource) {
//    	result.setSuccess(true);
//    	result.setCode(CommonResponse.SUCCESS.getCode());
//    	result.setMsg(CommonResponse.SUCCESS.getMsg());
